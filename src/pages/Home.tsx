  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <header className="text-center p-10">
        <h1 className="text-3xl font-bold text-gray-700">Welcome to UL Student Academic Advisory and Career Counseling Center</h1>
        <h2 className="text-2xl font-bold text-gray-700">(UL-SA <sup>2</sup>C<sup>3</sup>)</h2>
